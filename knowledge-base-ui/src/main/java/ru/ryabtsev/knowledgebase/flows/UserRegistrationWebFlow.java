...
@Configuration
public class UserRegistrationWebFlow extends AbstractFlowConfiguration {
    ...
    @Autowired
    public UserRegistrationWebFlow(LocalValidatorFactoryBean localValidatorFactoryBean, SpringTemplateEngine templateEngine) {
